...
#@comment: data view
from users.views import UserRegisterViewSet,LoginView,AddHouseInfoViewSet,AddPhotoViewSet,AddPhotoView
...
urlpatterns = [
    ...
    url(r'^addphoto/',AddPhotoView.as_view(),name='addphoto'),
